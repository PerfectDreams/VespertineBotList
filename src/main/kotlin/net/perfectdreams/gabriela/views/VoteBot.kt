...
object VoteBot {
	fun build(req: Request, botInfo: DiscordBot, bot: Member, userIdentification: TemmieDiscordAuth.UserIdentification?): StringWriter {
		return Base.build(req, bot.user.name, botInfo.color) {
			div {
				id = "content"
				div {
					id = "container"
